...
const Nav = () => {
  ...
  return (
    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="flex justify-between items-center h-16">
        ...
        <div className="flex items-center space-x-4">
          <HashLink to="/#top" className="text-lg font-bold flex items-center">
        ...
        <div className="hidden md:flex">
          <HashLink
            to="/#contact"
            className="px-3 py-2 rounded-md text-sm font-medium last-nav"
          >
            Contact
          </HashLink>
        </div>
        ...
        <div className="md:hidden">
          <button
            ...
            className="inline-flex items-center justify-center p-2 rounded-md text-white hover:text-[#9d977f] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#162640] focus:ring-white"
          >
            <svg
    ...
    <div className={`menu-open md:hidden ${menuOpen ? "active" : ""}`}>
